...
source_json = "{'as': 1, 'a': {'b': {'cs':10, 'qqq': {'qwe':1}}, 'd': {'csd':30}}}"
target_json = "{'as': 1, 'a': {'b': {'ds':10, 'qqq': {'qwe':11}}, 'd': {'dsd':40}}}"
...
class TestCompareFiles(Compare):
    ...
    def test_compare_workbooks(self):
        ...
        if files type is xl, xl file will be generated with file difference.
        """
    ...
    def test_compare_files(self):
        ...
        if files type is xl and non xl, xl file will be generated with file difference.
        """
