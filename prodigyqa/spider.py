...
class Webspider(BrowserActions):
    ...
    def spider(self, parent_url, login: bool=False,
               username: dict="", password: dict="", login_button: dict=''):
        ...
        if login:
            ...
            tmp = open("..\\prodigyqa\\setup_scrapper.tmpl", "r")
            setup = open("..\\prodigyqa\\setup_scrapper.py", "w+")
